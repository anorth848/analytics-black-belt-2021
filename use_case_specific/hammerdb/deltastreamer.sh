...
--source-class org.apache.hudi.utilities.sources.ParquetDFSSource
--enable-hive-sync
--target-table hammerdb_public_orders
--target-base-path s3://da-black-belt-2021-datalakestack-silverlakebucket-112e2j6kous0x/rdbms_analytics/hammerdb_public_orders/
--source-ordering-field trx_seq
-op BULK_INSERT
--hoodie-conf hoodie.table.name=hammerdb_public_orders -
-hoodie-conf hoodie.datasource.write.recordkey.field=o_w_id,o_d_id,o_id
--hoodie-conf hoodie.datasource.write.precombine.field=trx_seq
--hoodie-conf hoodie.datasource.hive_sync.database=rdbms_analytics
--hoodie-conf hoodie.datasource.hive_sync.enable=true
--hoodie-conf hoodie.datasource.hive_sync.table=hammerdb_public_orders
--hoodie-conf hoodie.datasource.write.operation=bulk_insert
--hoodie-conf hoodie.bulkinsert.sort.mode=PARTITION_SORT
--hoodie-conf hoodie.deltastreamer.source.dfs.root=s3://da-black-belt-2021-datalakestack-bronzelakebucket-19216ilyowszc/rdbms_analytics/full/hammerdb/public/orders/
--hoodie-conf hoodie.datasource.write.keygenerator.class=org.apache.hudi.keygen.NonpartitionedKeyGenerator
--hoodie-conf hoodie.datasource.hive_sync.partition_extractor_class=org.apache.hudi.hive.NonPartitionedExtractor
...
--source-class org.apache.hudi.utilities.sources.ParquetDFSSource
--enable-hive-sync
--target-table hammerdb_public_stock
--target-base-path s3://da-black-belt-2021-datalakestack-silverlakebucket-112e2j6kous0x/rdbms_analytics/hammerdb_public_stock/
--source-ordering-field trx_seq
--op BULK_INSERT
--hoodie-conf hoodie.table.name=hammerdb_public_stock
--hoodie-conf hoodie.datasource.write.recordkey.field=s_i_id,s_w_id
--hoodie-conf hoodie.datasource.write.precombine.field=trx_seq
--hoodie-conf hoodie.datasource.hive_sync.database=rdbms_analytics
--hoodie-conf hoodie.datasource.hive_sync.enable=true
--hoodie-conf hoodie.datasource.hive_sync.table=hammerdb_public_stock
--hoodie-conf hoodie.datasource.write.operation=bulk_insert
--hoodie-conf hoodie.bulkinsert.sort.mode=PARTITION_SORT
--hoodie-conf hoodie.deltastreamer.source.dfs.root=s3://da-black-belt-2021-datalakestack-bronzelakebucket-19216ilyowszc/rdbms_analytics/full/hammerdb/public/stock/
--hoodie-conf hoodie.datasource.write.hive_style_partitioning=true
--hoodie-conf hoodie.datasource.write.partitionpath.field=s_w_id
--hoodie-conf hoodie.datasource.hive_sync.partition_fields=s_w_id
--hoodie-conf hoodie.datasource.write.keygenerator.class=org.apache.hudi.keygen.ComplexKeyGenerator
--hoodie-conf hoodie.datasource.hive_sync.partition_extractor_class=org.apache.hudi.hive.MultiPartKeysValueExtractor

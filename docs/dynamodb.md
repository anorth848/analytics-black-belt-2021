...
|rdbms_analytics|pipeline::system::full_load|
|rdbms_analytics|table:system:public.customer|
...
System pipelines can be one of `[full_load|seed_hudi|incremental_hudi|continuous_hudi]`   
